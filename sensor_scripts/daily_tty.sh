...
awk 'FNR==0{print ""}{print}' $DIR/* > $HOME/ttylog.tmp


# Combine the final transaction.id and event.hash into a single line
# for input to DShield-SIEM with filebeat

paste -d, - -  < $HOME/ttylog.tmp  > $DIRECTORY/ttylog.txt
